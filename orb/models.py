...
class Resource(TimestampBase):
    ...
    #                                help_text=_(u"The peer ORB from which the resource was downloaded."), on_delete=models.SET_NULL)
...
class ResourceWorkflowTracker(models.Model):
    ...
    resource = models.ForeignKey(Resource, blank=True, null=True,
                                 related_name="workflow_trackers", on_delete=models.SET_NULL)
    create_user = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.SET_NULL)
