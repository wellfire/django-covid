    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_user', models.ForeignKey(related_name='resource_create_user', to=settings.AUTH_USER_MODEL, blank=True, null=True, default=None, on_delete=models.SET_NULL)),
                ('update_user', models.ForeignKey(related_name='resource_update_user', to=settings.AUTH_USER_MODEL, blank=True, null=True, default=None, on_delete=models.SET_NULL)),
            ],
            options={
